...
无论是参加国际会议还是在相关国际会议上发表演讲，或是参与黑客马拉松赛等各种活动，都仍然是 Core
...
该部分社区认领计划的资金来自 _Core 团队 工作量预算_ 中未分配的部分，即 _表格 1_ 中详述的 Core
团队中的空缺角色部分。
...
部分 Core 团队成员将会在每次规划的开发者会议活动前聚会，以进行团队建设、面对面协作或准备演示的内容。Core
